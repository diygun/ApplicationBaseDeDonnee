...
namespace Projet_DB_ManagmentAPP.Classes
{
 ...
 public class C_t_produit
 {
  ...
  public C_t_produit()
  { }
  public C_t_produit(string Nom_, decimal Prix_vente_, decimal Prix_achat_, int Quantite_stock_, double TVA_, int Seuil_stock_)
  {
   Nom = Nom_;
  ...
  public C_t_produit(int ID_produit_, string Nom_, decimal Prix_vente_, decimal Prix_achat_, int Quantite_stock_, double TVA_, int Seuil_stock_)
   : this(Nom_, Prix_vente_, Prix_achat_, Quantite_stock_, TVA_, Seuil_stock_)
  {
